<!DOCTYPE html>
<html lang="hu"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>{{ $quiz->title }} próba | KwizzGo</title>@vite(['resources/css/app.css','resources/js/app.js'])</head>
...
<main class="mx-auto max-w-3xl px-4 py-10"><section class="rounded-3xl border border-amber-400/30 bg-slate-900 p-6 shadow-2xl sm:p-9">
    ...
    <p class="mt-5 text-center text-sm text-slate-400">Nincs segítség, visszapörgetés vagy kockadobás. A próba nem módosít pontot és statisztikát.</p>
